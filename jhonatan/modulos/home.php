                ...
                <div class="col-lg-15 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-9">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Bem Vindo ao Portal Tiradentes - Senac São José 🎉</h5>
                          <p class="mb-4">
                            Ainda estamos em construção. Em breve teremos muitas <span class="fw-bold">novidades</span>. Tem alguma dúvida ou sugestão? Clique no botão abaixo.
                          </p>
                          <a href="mailto:jhonatan.bruno@sc.senac.br?subject=Sugestão Portal Senac SJ" class="btn btn-sm btn-outline-primary">Enviar Mensagem</a>
                        </div>
                      </div>
                      <div class="col-sm-1 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-8">
                          <img
                    ...
                    <div class="col-lg-8 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <small class="text-light fw-semibold">Relatórios</small>
                          <h4 class="card-title text-nowrap mt-3 mb-1">Relatório PSG</h4>
                          <div class="mt-3">
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel1">Escolha a Regional:</h5>                                    
                                  </div>
                                      ...
                                      <div class="card-body">
                                        <div class="table-responsive text-nowrap">
                                          <table class="table table-bordered">
                                            <tbody>
                                              <tr>
                                              <td><a href="/modulos/relatorios/psgES.php">Espirito Santo</td></a>
